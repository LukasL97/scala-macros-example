...
In this blog post we will take a look at macro annotations, a powerful tool for code transformation and generation in Scala (2.13).
...
without an equivalent replacement so far.
